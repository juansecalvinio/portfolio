...
const experience: WorkItemProps[] = [
  {
    ...
    description:
      "I worked on many projects for the Investments area of the bank. I developed web microfrontends with React, mobile microapps using React Native, and APIs with Nest. I worked with different teams and external partners to build new features and improve the user experience for investment products.",
    startTime: "2020",
    endTime: "Present",
  },
  {
